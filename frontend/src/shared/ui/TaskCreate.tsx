/**
Компонент создания задания
Содержит только ui
Принимает функцию обработчик отправки формы создания задания
Поскольку этот компонент будет использоваться отдельно в контексте создания задания 
в банке заданий и в контексте добавления нового задания в вариант
в разных местах будут прокидываться разные функции
*/
