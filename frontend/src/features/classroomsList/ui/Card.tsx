...
export const Card = ({
  ...
  return (
    <div className="w-full sm:max-w-md md:max-w-lg lg:max-w-xl mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
