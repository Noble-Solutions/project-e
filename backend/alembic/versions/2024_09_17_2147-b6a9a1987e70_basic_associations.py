...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['teacher_id'], ['teachers.id'], name=op.f('fk_classrooms_teacher_id_teachers'), ondelete='cascade'),
    ...
    sa.ForeignKeyConstraint(['student_id'], ['students.id'], name=op.f('fk_student_variant_association_student_id_students')),
    sa.ForeignKeyConstraint(['variant_id'], ['variants.id'], name=op.f('fk_student_variant_association_variant_id_variants')),
    ...
    sa.ForeignKeyConstraint(['task_id'], ['tasks.id'], name=op.f('fk_variant_task_association_task_id_tasks')),
    sa.ForeignKeyConstraint(['variant_id'], ['variants.id'], name=op.f('fk_variant_task_association_variant_id_variants')),
